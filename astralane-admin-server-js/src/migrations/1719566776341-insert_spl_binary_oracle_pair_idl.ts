...
export class InsertSplBinaryOraclePairIdl1719566776341
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.manager
        ...
        .into('program_idl')
        .values({
          program_pubkey: 'Fd7btgySsrjuo25CJCj7oE7VPMyezDhnx7pZkj2v69Nk',
          idl: idl,
        })
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `DELETE FROM program_idl WHERE program_pubkey = 'Fd7btgySsrjuo25CJCj7oE7VPMyezDhnx7pZkj2v69Nk';`,
      );
    } catch (error) {
