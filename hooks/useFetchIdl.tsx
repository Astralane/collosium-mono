...
import { Idl } from "@/app/types/idl";

const useFetchIdl = (pubKey?: string) => {
  return useQuery<string, unknown, Idl>({
    queryKey: ["idl", pubKey],
    queryFn: () => fetchIdl(pubKey),
    enabled: false,
  });
};

const fetchIdl = async (pubKey?: string) => {
