...
export class InsertSplTokenSwapIdl1719572765812 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.manager
        ...
        .into('program_idl')
        .values({
          program_pubkey: 'SwapsVeCiPHMUAtzQWZw7RjsKjgCjhwU55QGu4U1Szw',
          idl: idl,
        })
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `DELETE FROM program_idl WHERE program_pubkey = 'SwapsVeCiPHMUAtzQWZw7RjsKjgCjhwU55QGu4U1Szw';`,
      );
    } catch (error) {
