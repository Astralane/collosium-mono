...
export class ISandwichesDTO {
  ...
  slot: number;
  @Expose()
  'frontrun_swaps.tx_hash': string[];
  @Expose()
  'frontrun_swaps.multi_location': string[];
  @Expose()
  'frontrun_swaps.from': string[];
  @Expose()
  'frontrun_swaps.pool': string[];
  @Expose()
  ...
  @Expose()
  'victim_swaps.tx_hash': string[];
  @Expose()
  'victim_swaps.multi_location': string[];
  @Expose()
  'victim_swaps.from': string[];
  @Expose()
  'victim_swaps.pool': string[];
  @Expose()
  ...
  @Expose()
  'backrun_swaps.tx_hash': string;
  @Expose()
  'backrun_swaps.multi_location': string[];
  @Expose()
  'backrun_swaps.from': string[];
  @Expose()
  'backrun_swaps.pool': string[];
  @Expose()
 ...
 * 
 * 
 * "frontrun_tx_hash" : "5DutKgtRWTDNMFHcbSfPm15eJPDNfvN1shYVzzJ5mFHkXWSSuZzchvMyycYDCZ7qvg3pH8VYK2guMWnSZVHXdmLC",
		"slot" : 283581338,
		"frontrun_swaps.tx_hash" : "['5DutKgtRWTDNMFHcbSfPm15eJPDNfvN1shYVzzJ5mFHkXWSSuZzchvMyycYDCZ7qvg3pH8VYK2guMWnSZVHXdmLC']",
		...
		"victim_swaps.tx_hash" : "['436jY4YFtC2HjrtJKZGtXRCUYpJdKjmxGe5Qn2qWjNy2tjcbtzbUhXYJxuhw7dqNXuaTc6NBEX7PEjX7zCTHXt8Q']",
		...
		"backrun_tx_hash" : "5W3sMcndgyr5cZQUFMJBL6p2gsTMi43o4newxXakmq71PXyHhJddf25EANb8BBNedFUVXBDTGvEVEsGb24f7Aw8L",
		"backrun_swaps.tx_hash" : "['5W3sMcndgyr5cZQUFMJBL6p2gsTMi43o4newxXakmq71PXyHhJddf25EANb8BBNedFUVXBDTGvEVEsGb24f7Aw8L']",
