...
export class InsertSplBinaryOptionIdl1719565875436
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.manager
        ...
        .into('program_idl')
        .values({
          program_pubkey: 'betw959P4WToez4DkuXwNsJszqbpe3HuY56AcG5yevx',
          idl: idl,
        })
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `DELETE FROM program_idl WHERE program_pubkey = 'betw959P4WToez4DkuXwNsJszqbpe3HuY56AcG5yevx';`,
      );
    } catch (error) {
