...
export class InsertSplTokenIdl1719572115926 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.manager
        ...
        .into('program_idl')
        .values({
          program_pubkey: 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA',
          idl: idl,
        })
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `DELETE FROM program_idl WHERE program_pubkey = 'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA';`,
      );
    } catch (error) {
