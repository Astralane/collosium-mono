...
export class InsertSplTokenLengingIdl1719572618074
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      await queryRunner.manager
        ...
        .into('program_idl')
        .values({
          program_pubkey: 'FJAwitEMXUEUibVHXXwpikL7Ct1xTujaY2XMtccUBSoK',
          idl: idl,
        })
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      await queryRunner.query(
        `DELETE FROM program_idl WHERE program_pubkey = 'FJAwitEMXUEUibVHXXwpikL7Ct1xTujaY2XMtccUBSoK';`,
      );
    } catch (error) {
